...
var _fetchPhoto = require("./js/fetch-photo");
var _fetchPhotoDefault = parcelHelpers.interopDefault(_fetchPhoto);
...
var _onlyScrollbar = require("only-scrollbar");
var _onlyScrollbarDefault = parcelHelpers.interopDefault(_onlyScrollbar);
var _infiniteScroll = require("infinite-scroll");
var _infiniteScrollDefault = parcelHelpers.interopDefault(_infiniteScroll);
const pixabayAPIService = new (0, _fetchPhotoDefault.default)();
...
/** lazy scrolling */ new (0, _onlyScrollbarDefault.default)(document.scrollingElement, {
    damping: 0.6
});
/** infinite scroll */ const optionsScroll = {
    rootMargin: "200px"
};
const onLoadMore = (entries)=>{
    entries.forEach(async (entry)=>{
        if (entry.isIntersecting && pixabayAPIService.query !== "" && pixabayAPIService.lengthArrayPhotos >= pixabayAPIService.perPage) {
        ...
        } else if (pixabayAPIService.lengthArrayPhotos < pixabayAPIService.perPage && timerNotifyEndPhotos === 1) {
            reachedEndSearch();
...
/** function after form submit */ async function onSubmit(evt) {
    evt.preventDefault();
    ...
    if (!searchQuery || searchQuery.length < 3) {
        (0, _notiflix.Notify).warning("Warning! Search must not be empty and includes more then 2 letters", OPTIONS_NOTIFICATION);
        return;
    }
...
/** function for starting of photo loading */ function onLoadPhotos(response) {
    const totalHits = response.data.totalHits;
    if (totalHits === 0 && timerNotifyErrorFetch === 1) {
        (0, _notiflix.Notify).failure("Sorry, there are no images matching your search query. Please try again", OPTIONS_NOTIFICATION);
        timerNotifyErrorFetch = 2;
        return;
    }
    if (totalHits !== 0 && timerNotifyCountPhotos === 1) {
        (0, _notiflix.Notify).success(`Hooray! We found ${totalHits} images`, OPTIONS_NOTIFICATION);
...
function onMarkupPhotos(photos) {
    const markupPhotos = photos.map(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads ,  })=>{
...
function onError(error) {
    if (error.response) (0, _notiflix.Notify).failure(`Sorry, an error occurred - ${error.response.status}. Try again`, OPTIONS_NOTIFICATION);
    else if (error.request) (0, _notiflix.Notify).failure("Sorry, the request was made, but no response was received. Try again", OPTIONS_NOTIFICATION);
    else (0, _notiflix.Notify).failure("Something happened in setting up the request that triggered an Error. Try again", OPTIONS_NOTIFICATION);
}
...
function reachedEndSearch() {
    (0, _notiflix.Notify).warning(`We're sorry, but you've reached the end of search "${pixabayAPIService.getCurrentQuery.toUpperCase()}". Please start a new search`, {
        timeout: 5000,
...
},{"./css/styles.css":"1CY4s","./js/fetch-photo":"8XVcE","notiflix":"5WWYd","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","only-scrollbar":"kXriW","infinite-scroll":"32TaZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"8XVcE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class PixabayAPIService {
    constructor(){
        this.baseUrl = "https://pixabay.com/api/?image_type=photo&orientation=horizontal&safesearch=true";
    ...
    async onFetchPhotos() {
        ...
        const res = await (0, _axiosDefault.default).get(url);
...
},{}],"kaxSc":[function() {},{}],"kXriW":[function(require,module,exports) {
!function(e, t) {
    module.exports = t();
}(this, function() {
    return (()=>{
        ...
        var e1 = {};
        return (()=>{
            var t1 = e1, o1 = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1), n1 = function(e) {
                e.touches.length > 1 || e.preventDefault && e.preventDefault();
            }, i1 = function() {
                function e2(e3, t2) {
                    var i, l, s = this;
                    this.classNames = {
                        ...
                        s.lastPosition = s.scrollY, s.scrollY = Math.abs(s.scrollContainer.scrollTop), s.direction !== s.lastDirection && (s.scrollContainer.dataset.scrollDirection = 1 === s.direction ? "down" : "up", s.lastDirection = s.direction);
                    }, this.sync = function() {
                        s.syncPos(), s.rafID = null;
                    }, this.scrollTo = function(e) {
                        s.targetY = e, s.tick();
                    }, this.setValue = function(e) {
                        s.scrollContainer.scrollTop = e, s.sync();
                    }, this.lock = function() {
                        s.isLocked || (o1 ? s.disableIosScroll() : s.scrollContainer.style.overflow = "hidden", s.scrollContainer.classList.add(s.classNames.lock), s.eventContainer.removeEventListener("wheel", s.onWheel), s.isLocked = !0, s.sync());
                    }, this.unlock = function() {
                        s.isLocked && (o1 ? s.enableIosScroll() : s.scrollContainer.style.overflow = "auto", s.scrollContainer.classList.remove(s.classNames.lock), s.eventContainer.addEventListener("wheel", s.onWheel, {
                            passive: !1
                        }), s.isLocked = !1, s.tick());
                    }, this.addScrollListener = function(e) {
                        s.eventContainer.addEventListener("scroll", e), s.listeners.add(e);
                    }, this.removeScrollListener = function(e) {
                        s.eventContainer.removeEventListener("scroll", e), s.listeners.delete(e);
                    }, this.destroy = function() {
                        var e4;
                        s.syncTo && clearTimeout(s.syncTo), s.scrollContainer.style.removeProperty("overflow"), (e4 = s.scrollContainer.classList).remove.apply(e4, Object.values(s.classNames)), s.scrollContainer.removeAttribute("data-scroll-direction"), (s.scrollContainer === document.documentElement ? window : s.scrollContainer).removeEventListener("scroll", s.onScroll), s.eventContainer.removeEventListener("wheel", s.onWheel), Array.from(s.listeners.values()).forEach(function(e) {
                            return s.removeScrollListener(e);
                        });
                    }, this.findElementBySelector = function(e) {
                        var t;
                        return e !== window && e !== document.scrollingElement ? "string" == typeof e ? document.querySelector(e) : e : null !== (t = document.scrollingElement) && void 0 !== t ? t : document.body;
                    }, this.init = function() {
                        s.scrollContainer.style.overflow = "auto", s.scrollContainer.style.scrollBehavior = "auto", s.scrollContainer.dataset.scrollDirection = "up", s.scrollContainer.classList.add(s.classNames.container), s.initEvents(), s.findInitialAnchor();
                    }, this.initEvents = function() {
                        (s.scrollContainer === document.documentElement ? window : s.scrollContainer).addEventListener("scroll", s.onScroll, {
                            passive: !0
                        }), s.eventContainer.addEventListener("wheel", s.onWheel, {
                            passive: !1
                        });
                    }, this.findInitialAnchor = function() {
                        if (window.location.hash) {
                            var e = document.querySelector(window.location.hash);
                            e && requestAnimationFrame(function() {
                                return s.setValue(e.offsetTop);
                            });
                        }
                    }, this.onScroll = function() {
                        if (!s.isLocked && !s.isDisable) {
                            if (s.updateDirection(), window.location.hash !== s.lastHash) return s.lastHash = window.location.hash, void s.syncPos();
                            s.checkSyncTo();
                        }
                    }, this.onWheel = function(e) {
                        e.preventDefault(), s.isLocked || (s.manageParentScrollbars(e.target), s.isDisable || (s.targetY += s.wheelCalculate(e).pixelY, s.targetY = Math.min(s.targetY, s.scrollContainer.scrollHeight - s.scrollContainer.clientHeight), s.targetY = Math.max(s.targetY, 0), null === s.rafID && s.tick()));
                    }, this.syncPos = function() {
                        s.easedY = s.scrollContainer.scrollTop, s.targetY = s.scrollContainer.scrollTop, s.lastY = s.scrollContainer.scrollTop, s.scrollY = s.scrollContainer.scrollTop;
                    }, this.checkSyncTo = function() {
                        s.syncTo && clearTimeout(s.syncTo), s.syncTo = setTimeout(s.sync, 100);
                    }, this.wheelCalculate = function(e) {
                        var t = e.deltaY, o = e.deltaX;
                        if (e.deltaMode) {
                            var n = 1 == e.deltaMode ? 40 : 800;
                            o *= n, t *= n;
                        }
                        return {
                            spinX: o < 1 ? -1 : 1,
                    ...
                    }, this.manageParentScrollbars = function(e) {
                        var t;
                        (null === (t = e.closest(".".concat(s.classNames.container))) || void 0 === t ? void 0 : t.isSameNode(s.scrollContainer)) ? s.isDisable && s.enable() : !s.isDisable && s.disable();
                    }, this.disable = function() {
                        s.isDisable = !0, s.sync();
                    }, this.enable = function() {
                        s.isDisable = !1, s.sync();
                    }, this.disableIosScroll = function() {
                        requestAnimationFrame(function() {
                            if (void 0 === s.previousBodyPosition) {
                                s.previousBodyPosition = {
                                    position: document.body.style.position,
                                    top: document.body.style.top,
                                    left: document.body.style.left
                                };
                                var e = window.scrollY, t3 = window.scrollX, o = window.innerHeight;
                                document.body.style.position = "fixed", document.body.style.top = "".concat(-e, "px"), document.body.style.left = "".concat(-t3, "px"), setTimeout(function() {
                                    return window.requestAnimationFrame(function() {
                                        var t = o - window.innerHeight;
                                        t && e >= o && (document.body.style.top = -(e + t) + "px");
                                    });
                                }, 300);
                            }
                        }), s.scrollContainer.ontouchstart = function(e) {
                            1 === e.targetTouches.length && (s.initialClientY = e.targetTouches[0].clientY);
                        }, s.scrollContainer.ontouchmove = function(e) {
                            if (1 === e.targetTouches.length) {
                                var t = e.targetTouches[0].clientY - s.initialClientY;
                                return s.scrollContainer && 0 === s.scrollContainer.scrollTop && t > 0 && n1(e), s.scrollContainer.scrollHeight - s.scrollContainer.scrollTop <= s.scrollContainer.clientHeight && t < 0 && n1(e), void e.stopPropagation();
                            }
                        }, s.documentListenerAdded || (document.addEventListener("touchmove", n1, {
                            passive: !1
                        }), s.documentListenerAdded = !0);
                    }, this.enableIosScroll = function() {
                        if (s.scrollContainer.ontouchstart = null, s.scrollContainer.ontouchmove = null, s.documentListenerAdded && (document.removeEventListener("touchmove", n1), s.documentListenerAdded = !1), void 0 !== s.previousBodyPosition) {
                            var e = -parseInt(document.body.style.top, 10), t = -parseInt(document.body.style.left, 10);
                            document.body.style.position = s.previousBodyPosition.position, document.body.style.top = s.previousBodyPosition.top, document.body.style.left = s.previousBodyPosition.left, window.scrollTo(t, e), s.previousBodyPosition = void 0;
                        }
                    }, this.tick = function() {
                        s.easedY = +((1 - s.damping) * s.easedY + s.damping * s.targetY).toFixed(2), s.scrollContainer.scrollTop = Math.round(s.easedY), s.lastY !== s.easedY ? (s.lastY = s.easedY, s.velocity = parseInt((s.targetY - s.easedY).toString()), s.progress = Math.round(s.easedY / (s.scrollContainer.scrollHeight - s.scrollContainer.clientHeight) * 100), s.rafID = requestAnimationFrame(s.tick)) : s.rafID = null;
                    };
                    var r = this.findElementBySelector(e3);
                    if (!r) throw new Error("scrollElement does not exist");
                    this.scrollContainer = r;
                    var c = null !== (i = this.findElementBySelector(null == t2 ? void 0 : t2.eventContainer)) && void 0 !== i ? i : this.scrollContainer;
                    this.eventContainer = c === document.scrollingElement ? window : c, this.scrollY = 0, this.easedY = 0, this.targetY = 0, this.lastY = 0, this.velocity = 0, this.progress = 0, this.lastPosition = 0, this.lastDirection = null, this.isLocked = !1, this.rafID = null, this.damping = .1 * (null !== (l = null == t2 ? void 0 : t2.damping) && void 0 !== l ? l : 1), this.lastHash = window.location.hash, this.listeners = new Set, this.isDisable = !1, this.initialClientY = -1, this.documentListenerAdded = !1, this.init();
                }
                return Object.defineProperty(e2.prototype, "direction", {
                    get: function() {
                        return this.scrollY > this.lastPosition ? 1 : -1;
                    },
                    enumerable: !1,
                    configurable: !0
                }), Object.defineProperty(e2.prototype, "y", {
                    get: function() {
                        return this.scrollY;
                    },
                    enumerable: !1,
...
},{}],"32TaZ":[function(require,module,exports) {
/*!
...
},{"./core":"dsw82","./page-load":"a8S8c","./scroll-watch":"8jwDd","./history":"cpzdQ","./button":"9OtVr","./status":"134ul"}],"dsw82":[function(require,module,exports) {
// core
(function(window, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    ...
    proto.dispatchEvent = function(type, event, args) {
        ...
        if (event) {
            // create jQuery event
            /* eslint-disable-next-line new-cap */ let jQEvent = jQuery.Event(event);
            jQEvent.type = type;
            $event = jQEvent;
        }
    ...
    proto.updateScroller = function() {
        ...
        if (!this.scroller) throw new Error(`Unable to find elementScroll: ${elementScroll}`);
    };
    // -------------------------- page path -------------------------- //
    ...
    proto.destroy = function() {
        ...
        if (jQuery && this.$element) jQuery.removeData(this.element, "infiniteScroll");
    };
    // -------------------------- utilities -------------------------- //
    ...
    if (jQuery && jQueryBridget) jQueryBridget("infiniteScroll", InfiniteScroll, jQuery);
    // --------------------------  -------------------------- //
    return InfiniteScroll;
});

},{"ev-emitter":"7rCHo","fizzy-ui-utils":"5rzsv"}],"7rCHo":[function(require,module,exports) {
/**
 * EvEmitter v2.1.1
 * Lil' event emitter
 * MIT License
...
},{}],"a8S8c":[function(require,module,exports) {
// page-load
(function(window, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    ...
    InfiniteScroll.create.pageLoad = function() {
        ...
        if (this.options.outlayer) this.on("append", this.onAppendOutlayer);
    };
    ...
    proto.loadNextPage = function() {
        ...
        let fetchPromise = fetch(path, fetchOptions).then((response)=>{
            ...
            return response[responseBody]().then((body)=>{
                ...
                if (canDomParse) body = domParser.parseFromString(body, "text/html");
                ...
                } else return this.onPageLoad(body, path, response);
            });
        }).catch((error)=>{
            this.onPageError(error, path);
        });
        this.dispatchEvent("request", null, [
            path,
            fetchPromise
        ]);
        return fetchPromise;
    ...
    proto.appendNextPage = function(body, path, response) {
        ...
        if (this.options.outlayer) return this.appendOutlayerItems(fragment, appendReady);
        else return appendReady();
    };
    ...
    proto.checkLastPage = function(body, path) {
        ...
        let selector;
        if (typeof checkLastPage == "string") selector = checkLastPage;
        else if (this.isPathSelector) // path option is selector string
        selector = pathOpt;
    ...
    proto.prefill = function() {
        ...
        if (this.isPrefilling) {
            this.log("prefill");
            this.loadNextPage();
        } else this.stopPrefill();
    };
    proto.getPrefillDistance = function() {
        // element scroll
        if (this.options.elementScroll) return this.scroller.clientHeight - this.scroller.scrollHeight;
        // window
...
},{"./core":"dsw82"}],"8jwDd":[function(require,module,exports) {
// scroll-watch
(function(window, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    ...
    proto.onPageScroll = InfiniteScroll.throttle(function() {
        ...
        if (distance <= this.options.scrollThreshold) this.dispatchEvent("scrollThreshold");
    });
...
},{"./core":"dsw82","fizzy-ui-utils":"5rzsv"}],"cpzdQ":[function(require,module,exports) {
// history
(function(window, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    ...
    InfiniteScroll.create.history = function() {
        ...
        if (this.options.append) this.createHistoryAppend();
        else this.createHistoryPageLoad();
    };
    ...
    InfiniteScroll.destroy.history = proto.destroyHistory = function() {
        ...
        if (isHistoryAppend) this.bindHistoryAppendEvents(false);
    };
    // ----- append history ----- //
    ...
    proto.getClosestScrollPage = function() {
        let scrollViewY;
        if (this.options.elementScroll) scrollViewY = this.scroller.scrollTop + this.scroller.clientHeight / 2;
        else scrollViewY = window.scrollY + this.windowHeight / 2;
        let scrollPage;
...
},{"./core":"dsw82","fizzy-ui-utils":"5rzsv"}],"9OtVr":[function(require,module,exports) {
// button
(function(window, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    ...
    InfiniteScroll.create.button = function() {
        ...
        if (buttonElem) this.button = new InfiniteScrollButton(buttonElem, this);
    };
...
},{"./core":"dsw82","fizzy-ui-utils":"5rzsv"}],"134ul":[function(require,module,exports) {
// status
(function(window, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    ...
    function setDisplay(elem, value) {
        if (elem) elem.style.display = value;
    }
    // --------------------------  -------------------------- //
    return InfiniteScroll;
});

},{"./core":"dsw82","fizzy-ui-utils":"5rzsv"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
